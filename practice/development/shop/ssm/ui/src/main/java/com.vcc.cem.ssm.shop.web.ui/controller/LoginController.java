package com.vcc.cem.ssm.shop.web.ui.controller;

import com.google.code.kaptcha.Constants;
import com.vcc.cem.ssm.shop.commons.constant.Constant;
import com.vcc.cem.ssm.shop.commons.dto.BaseResult;
import com.vcc.cem.ssm.shop.commons.util.Email;
import com.vcc.cem.ssm.shop.web.ui.api.UsersApi;
...
public class LoginController {
    ...
    public String login(TbUser tbUser, Model model, HttpServletRequest request) throws Exception {
        ...
        // 登录成功
            ...
            email.send("用户登录", String.format("用户 【%s】 登录 MyShop", user.getUsername()), "lusifer@yeah.net");
            // 将会员信息放入 Session
